...
{
	cubeVertexPosition[0] = Vector3D(0.25, 0.25, 0.1);
	cubeVertexPosition[1] = Vector3D(-0.25, 0.25, 0.1);
	cubeVertexPosition[2] = Vector3D(-0.25, -0.25, 0.1);
	cubeVertexPosition[3] = Vector3D(0.25, -0.25, 0.1);
	cubeVertexPosition[4] = Vector3D(0.25, 0.25, 0.6);
	cubeVertexPosition[5] = Vector3D(-0.25, 0.25, 0.6);
	cubeVertexPosition[6] = Vector3D(-0.25, -0.25, 0.6);
	cubeVertexPosition[7] = Vector3D(0.25, -0.25, 0.6);
