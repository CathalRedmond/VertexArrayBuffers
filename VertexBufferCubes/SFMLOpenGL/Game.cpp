...
void Game::initialize()
{
	...
	vertex[7].coordinate[0] = 0.8f;
	vertex[7].coordinate[1] = 0.6f;
	vertex[7].coordinate[2] = 0.0f;

	vertex[8].coordinate[0] = 0.6f;
	vertex[8].coordinate[1] = -0.6f;
	...
	triangles[7] = 7;   triangles[8] = 8;   triangles[9] = 9;
